...
CREATE TABLE `categorias_notas` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  CONSTRAINT `categorias_notas_fk` FOREIGN KEY (`id`) REFERENCES `notas` (`id`),
  CONSTRAINT `categorias_notas_fk_1` FOREIGN KEY (`id`) REFERENCES `categorias` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notas` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `notas_fk` FOREIGN KEY (`id`) REFERENCES `usuarios` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping routines for database 'digital'
--
...
-- Dump completed on 2021-09-08 21:22:07
